...
const TREE_ABI = [
  ...
  "function addNodeWithTokenForUser(bytes32 parentId, string memory content, string memory tokenName, string memory tokenSymbol, address author) external returns (bytes32)",
